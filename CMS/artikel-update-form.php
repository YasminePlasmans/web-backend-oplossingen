...
<html>
    ...
    <body>
         ...
         <form action="<?= HOST ?>artikel-update.php" method="post">
            <ul>
            	<li>
            		<input type="hidden" name="id" value="<?= $artikelArray[0]['id']  ?>">
            	</li>
                <li>
                    <label for="titel">Titel</label>
                    <input type="text" name="titel" value="<?= $artikelArray[0]['titel'] ?>">
                </li>
                <li>
                    <label for="artikel">Artikel</label>
                    <textarea name="artikel"><?= $artikelArray[0]['artikel']  ?></textarea>
                </li>
                <li>
                    <label for="kernwoorden">Kernwoorden</label>
                    <input type="text" name="kernwoorden" value="<?= $artikelArray[0]['kernwoorden']  ?>">
                </li>
                <li>
                ...
                <li>
                    <input type="submit" name="update-artikel" value="Update het artikel">
                </li>
            </ul>
        </form>
    </body>
